            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="firstname" class="col-md-3 col-form-label text-md-start">{{ __('Username') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="firstname" class="col-md-3 col-form-label text-md-start">{{ __('First name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="lastname" class="col-md-3 col-form-label text-md-start">{{ __('Last name') }}</label>
